...
public class CustomerView extends JPanel 
{
	...
	public void registCustomer(){
		...
		// (2) constructor
		// CustomerVO vo = new CustomerVO(name, tel, telAid, addr, email);
	...
	public void searchByTel(){
		...
		// 3. 2번의 넘겨받은 Customer의 각각의 값을 화면 텍스트 필드 지정
			...
			JOptionPane.showMessageDialog(null, "전화번호 검색이 완료되었습니다");
		} catch (Exception e) {
	...
	public void updateCustomer(){
		...
		// 3. Model 클래스 안의 updateCustomer() 메소드 호출하여 2번 VO 객체를 넘김
		try {
